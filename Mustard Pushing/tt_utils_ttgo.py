...
# This module incorporates code from TTGO (GPLv3):
#   Shetty et al., TTGO — Tensor Train-based Global Optimization (2022), Idiap Research Institute.
#   Source: https://github.com/idiap/ttgo
# Local changes in this repository:
#   - Minor integration adjustments for Isaac Gym
#   - Adapted function interfaces and imports for project structure
# Maintainer for adapted version: <amirreza.razmjoo@idiap.ch>
...
def refine_cores(tt_cores, site_list=[], scale_factor=2, device='cpu'):
    ...
    for site in site_list:
        ...
        idx = torch.arange(n_site).to('cuda:0')
